...
local Library = {
    ...
    AccentColor = Color3.fromRGB(235, 170, 180);
...
function Tab:AddTabbox(Info)
    ...
    function Tabbox:AddTab(Name)
        ...
        function Tab:Show()
            ...
            Library.RegistryMap[Highlight].Properties.BackgroundColor3 = "AccentColor"
        ...
        function Tab:Hide()
            ...
            Library.RegistryMap[Highlight].Properties.BackgroundColor3 = "BackgroundColor"
...
BlurEffect.Size = Toggled and 24 or 0
        if Toggled then
